...
CREATE TABLE `projects` (
  ...
  `small_descp` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `brief_descp` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `client_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pro_start` date DEFAULT NULL,
  `pro_end` date DEFAULT NULL,
  `status` enum('Active','Completed','Pending') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Active',
...
(1,	'Amazonal',	'amazon',	'amazon_logo.png',	'Amazon-Logo.png',	'Online Clothing Store',	'We are planning to develop an online clothing store that allows customers to browse and purchase a wide range of clothing items. The website will provide an intuitive and user-friendly interface, ensuring a seamless shopping experience for our customers.\r\n\r\nWe aim to create an e-commerce website that delivers a seamless shopping experience, promotes customer satisfaction, and drives business growth',	'1',	'2023-06-19',	NULL,	'Active',	'2 lacs',	'2023-06-19 15:54:07',	NULL),
