...
CREATE TABLE `banners` (
  ...
  `img_src` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `img_dimensions` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `img_extensions` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `img_status` enum('Active','Inactive') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Active',
  `img_descp` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `clients` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `client_descp` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `client_img_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `client_location` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `client_email` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `client_contact` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `client_requirement` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `client_requirement_img` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `client_solution` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `client_solution_img` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `client_status` enum('Active','Inactive') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Active',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `projects` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `anchor_keyword` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pro_logo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pro_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pro_small_descp` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pro_brief_descp` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `client_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pro_start` date DEFAULT NULL,
  `pro_end` date DEFAULT NULL,
  `pro_status` enum('Active','Completed','Pending') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Active',
  `pro_cost` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(5,	'Al Askandarani ',	'al_askandarani',	'logo_seafood-house.png',	'SEA-LOGO3.png',	'Askandarani seafood dishes',	'Askandarani seafood refers to a type of cuisine or seafood specialty that originates from the coastal region of Alexandria, Egypt, known as \"Askandarani\" or \"Alexandrian\" in Arabic. The region\'s proximity to the Mediterranean Sea provides abundant access to fresh seafood, which has become a prominent part of its culinary heritage.\r\n\r\nAskandarani seafood dishes often highlight a variety of locally caught fish, shellfish, and other marine delicacies. \r\n\r\nAskandarani seafood dishes are known for their vibrant flavors, freshness, and the use of aromatic herbs and spices. The cuisine often combines the flavors of the Mediterranean with traditional Egyptian and Middle Eastern influences, resulting in a rich and diverse seafood experience.',	NULL,	'2023-06-20',	NULL,	'Active',	NULL,	'2023-06-20 07:08:45',	NULL),
(6,	'Trex',	'trex',	'NYSE_TREX.png',	'TReX-BlackGreen-No-Tag.png',	'The T-Rex Project, often referred to as \"T-Rex,\"',	'The T-Rex Project, often referred to as \"T-Rex,\" is an ambitious initiative aimed at creating a life-sized replica or model of a Tyrannosaurus rex, one of the most iconic and well-known dinosaur species. The project seeks to provide an immersive and educational experience for visitors, showcasing the size, scale, and features of the mighty T-Rex.\r\n\r\nThe primary objective of the T-Rex Project is to accurately recreate the physical appearance and anatomical details of a T-Rex, utilizing the available scientific knowledge and research about these extinct creatures. The project involves a multidisciplinary team of paleontologists, artists, engineers, and experts in animatronics and special effects.',	NULL,	'2023-06-20',	NULL,	'Active',	NULL,	'2023-06-20 07:11:14',	NULL);
